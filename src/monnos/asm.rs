...
#[inline(always)]
pub unsafe fn asm_out8(port: u16, data: u8) {
    unsafe { asm!("out dx, al", in("dx")port, in("al")data) }
}

#[inline(always)]
pub unsafe fn asm_out16(port: u16, data: u16) {
    unsafe { asm!("out dx, ax", in("dx")port, in("ax")data) }
}

#[inline(always)]
pub unsafe fn asm_out32(port: u16, data: u32) {
    unsafe { asm!("out dx, eax", in("dx")port, in("eax")data) }
}

#[inline(always)]
pub unsafe fn asm_in8(port: u16) -> u8 {
    let mut data: u8;
...
#[inline(always)]
pub unsafe fn asm_in16(port: u16) -> u16 {
    let mut data: u16;
...
#[inline(always)]
pub unsafe fn asm_in32(port: u16) -> u32 {
    let mut data: u32;
